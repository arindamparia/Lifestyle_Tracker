...
const WORKOUTS = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Hindu Squats — 4 × 20 reps: Feet hip-width. As you squat, heels naturally rise and arms sweep back. As you rise, sweep arms forward. Keep a fluid, rhythmic motion — no pausing at bottom.',
      ...
      'Rest 60–90 seconds between sets. Total session: ~35–45 minutes.',
    ],
  },
  {
    day: 'Friday',
  ...
  },
  {
    ...
    steps: [
      ...
      'Focus on quality sleep (7–8 hours), 4 litres of water, and clean eating.',
